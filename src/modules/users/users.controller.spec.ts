...
describe('UsersController', () => {
    ...
    describe('findOne', () => {
        ...
        it('should throw NotFoundException when user not found', async () => {
            service.findOne.mockRejectedValue(new NotFoundException(USER_ERROR_MESSAGES.USER_NOT_FOUND(999)));
    ...
    describe('update', () => {
        ...
        it('should throw NotFoundException when user not found', async () => {
            service.update.mockRejectedValue(new NotFoundException(USER_ERROR_MESSAGES.USER_NOT_FOUND(999)));
    ...
    describe('replace', () => {
        ...
        it('should throw NotFoundException when user not found', async () => {
            service.replace.mockRejectedValue(new NotFoundException(USER_ERROR_MESSAGES.USER_NOT_FOUND(999)));
    ...
    describe('remove', () => {
        ...
        it('should throw NotFoundException when user not found', async () => {
            service.remove.mockRejectedValue(new NotFoundException(USER_ERROR_MESSAGES.USER_NOT_FOUND(999)));
